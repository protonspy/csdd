...
// place: csdd runs on Windows/WSL where the working tree is frequently CRLF, and
...
// parser and content hash in csdd should operate on so behaviour is identical
