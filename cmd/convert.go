...
// runConvert backs the intentionally undocumented ("silent") `kspec convert`
// command. It exists and is fully supported, but is omitted from `kspec --help`
// and from kspec.md on purpose — it is an escape hatch for porting a Kiro
...
func writeClaudeMd(root string, force bool) error {
	...
	b.WriteString("> Generated by `kspec convert claude` from the Kiro workspace. Re-run with `--force` after changing Kiro artifacts.\n\n")
	b.WriteString("This project follows the Kiro Spec-Driven Development workflow. The canonical, self-contained guide is `docs/guides/kiro_sdd.md`; the operational CLI guide is `kspec.md`.\n\n")
